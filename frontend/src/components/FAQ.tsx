...
const faqData: FAQData = {
    ...
    Cuenta: [
        { question: '¿Cómo puedo crear una cuenta?', answer: 'Crear una cuenta es un proceso sin complicaciones. Simplemente comience a utilizar nuestro convertidor de archivos después de que convierta su archivo, se le pedirá que cree una cuenta para continuar. Â¡Es así de fácil!' },
