...
export const IconUpload: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M3.75 18A5.25 5.25 0 009 20.25h6a5.25 5.25 0 005.25-2.25c0-2.882-2.343-5.25-5.25-5.25A5.25 5.25 0 009 7.5c-1.336 0-2.563.54-3.486 1.414A5.25 5.25 0 003.75 12z" />
  </svg>
);
...
export const IconRefresh: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.18-3.185m-3.18 3.183l-3.181-3.183m0 0v-4.992m0 0h-4.992m4.993 0l-3.18-3.184a8.25 8.25 0 00-11.664 0L2.985 19.644z" />
    </svg>
);
...
export const IconArrowRightCircle: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const IconArchive: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" />
  </svg>
);

export const IconPresentation: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 4.5h17.25a.375.375 0 01.375.375v14.25a.375.375 0 01-.375.375H3.375a.375.375 0 01-.375-.375V4.875c0-.207.168-.375.375-.375z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 8.25h12M6 12h12m-6 3.75h.008v.008H12v-.008z" />
    </svg>
);

export const IconFont: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5L7.5 19.5M16.5 19.5L12 4.5M4.5 15h15" />
    </svg>
);

export const IconEbook: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const IconInfinity: React.FC<IconProps> = ({ className }) => (
    <svg className={className} stroke="currentColor" fill="none" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path d="M10.623 5.472a8.999 8.999 0 0 1 7.229 3.028c1.666 1.667 2.648 3.94 2.648 6.272s-.982 4.605-2.648 6.272a8.999 8.999 0 0 1-11.528-2.029" strokeLinecap="round" strokeLinejoin="round"></path>
      <path d="M13.377 18.528a8.999 8.999 0 0 1-7.229-3.028C4.482 13.833 3.5 11.56 3.5 9.228s.982-4.605 2.648-6.272a8.999 8.999 0 0 1 11.528 2.029" strokeLinecap="round" strokeLinejoin="round"></path>
    </svg>
);
...
export const IconConverterLogo: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />
    </svg>
);

export const IconVisa: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
        <path fill="currentColor" d="M384 32H0v448h384V32zM64 368c0-4.42 3.58-8 8-8h56c4.42 0 8 3.58 8 8v48c0 4.42-3.58 8-8 8H72c-4.42 0-8-3.58-8-8v-48zm248-24c-11.05 0-20 8.95-20 20s8.95 20 20 20 20-8.95 20-20-8.95-20-20-20zm-88 0c-11.05 0-20 8.95-20 20s8.95 20 20 20 20-8.95 20-20-8.95-20-20-20zm-88 0c-11.05 0-20 8.95-20 20s8.95 20 20 20 20-8.95 20-20-8.95-20-20-20zm-48-184H96v128h32V160h32v128h32V160h32v128h32V160h32v128h32V160h32v128h32v-88c0-22.09-17.91-40-40-40h-48c-22.09 0-40 17.91-40 40v40H160v-40c0-22.09-17.91-40-40-40H72c-22.09 0-40 17.91-40 40v88z"/>
    </svg>
);

export const IconMastercard: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
        <path fill="currentColor" d="M576 32H0v448h576V32zM128 160h320v192H128V160zm160 224c-44.18 0-80-35.82-80-80s35.82-80 80-80 80 35.82 80 80-35.82 80-80 80zm160-80c0 44.18-35.82 80-80 80s-80-35.82-80-80 35.82-80 80-80 80 35.82 80 80z"/>
    </svg>
);
